...
MIDDLEWARE = [
    ...
    # enable whitenoise for static file management
...
AUTH_USER_MODEL = "accounts.CustomUser"  # use my custom abstract model

SITE_ID = 1
SITE_NAME = "Stock Trader"
...
REST_AUTH_REGISTER_SERIALIZERS = {
    "REGISTER_SERIALIZER": "accounts.serializers.MyCustomRegistrationSerializer",
}
...
REST_USE_JWT = True
JWT_AUTH_COOKIE = "stock-trader-auth"
